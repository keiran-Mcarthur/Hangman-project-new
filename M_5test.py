...
word_list (str): A list of possible word that could be randomly selected.
...
'''
    ...
    def check_guess(self, guess): 
        '''
        This function is used to convert guess into lowercase letters and check the guess to see if the guess is in the word.
